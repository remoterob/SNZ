...
function SNZHub() {
  ...
  const modules = [
    ...
    },
    {
      ...
      status: 'sponsor',
      summary: bigFishCount > 0
        ? `🤿 ${bigFishCount} competitor${bigFishCount === 1 ? '' : 's'} registered · Competition is live — submit your fish now.`
        : 'Competition is live — register now and start submitting your fish.',
    },
    {
